CREATE COLUMN TABLE "MKTG_CART_REQUEST_TOOL"."USER_RECOVERY_TOKEN"
(
...
ALTER TABLE "MKTG_CART_REQUEST_TOOL"."USER_RECOVERY_TOKEN" ADD FOREIGN KEY ( "USER_ID" ) REFERENCES "MKTG_CART_REQUEST_TOOL"."USER" ("USER_ID") ON UPDATE RESTRICT ON DELETE RESTRICT
;
